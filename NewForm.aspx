    ...
    <script type="text/javascript">
     ...
     $('#notification').click(function () {
        ...
        function getFile(fakepath) {
            ...
            if (IsValidateFile(splits[1])) {
                alert("HELLO");
                var _uploadedFileName = splits[1];
                ...
                if (_uploadedFileName.lastIndexOf(_endingWithCurrentDate) < 0) {
                    splits[1] = _uploadedFileName.substring(0, _uploadedFileName.lastIndexOf(".")) + "_" + _currentDate +
                        _uploadedFileName.substring(_uploadedFileName.lastIndexOf("."), _uploadedFileName.length);
                }


                var fileSelector = $("#file-uploader").on('change', (event) => {
                ...
                var modified_file = splits[1];


                $('#display-name').html(final_path);
                                ...
                                <div id="main" class="_3AUV4">
                                    ...
                                    <footer tabindex="-1" class="_3uxr9">
                                        <div class="vR1LG _3wXwX copyable-area darkable">
                                            ...
                                            <asp:button id="btnSendMsg" runat="server" text="Button" onclientclick="return false;" onclick="btnSendMsg_Click" autopostback="false" xmlns:asp="#unknown" />
                                            <div style="display: flex; height: 40px; width: 40px;">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
