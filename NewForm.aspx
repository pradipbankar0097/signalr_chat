    ...
    <script type="text/javascript">
        ...
        function getImage(fakepath) {
            ...
            if (IsValidateFile(splits[1])) {
                ...
                //imgDisplay.src = "<%# ResolveUrl(UploadFolderPath) %>" + _uploadedFileName;
                msg1 = " ";

                chatHub.server.sendMessageToAll(fromUserName, msg1, date);

                $('#display-image').html(splits[1]);
                                        ...
                                        <div class="_2C9f1">
                                            <div class="_2n-zq">
                                                <div
                                                    ...
                                                    <input type="file" name="" id="fileupload" style="display: none; visibility: hidden;" onchange="getImage(this.value);" />
